...
def main():
    ...
    postgres_url = f"jdbc:postgresql://{WAREHOUSE_ENDPOINT}:{WAREHOUSE_PORT}/{WAREHOUSE_DATABASE}"
    minio_client = Minio(
        endpoint=ENDPOINT,
    ...
    df_merge = spark.read.format("delta").load(f"s3a://{BUCKET_NAME}/{REFINED_MERGE_DATA_FOLDER}")
    ...
    dim_time_df.write \
        ...
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.dim_time") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
    ...
    dim_users_df.write \
        .format("jdbc") \
        .option("url", postgres_url) \
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.dim_users") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
        .option("driver", "org.postgresql.Driver") \
        .mode("append") \
    ...
    dim_reviews_text_df.write \
        .format("jdbc") \
        .option("url", postgres_url) \
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.dim_reviews") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
        .option("driver", "org.postgresql.Driver") \
        .mode("append") \
    ...
    dim_products_df.write \
        .format("jdbc") \
        .option("url", postgres_url) \
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.dim_products") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
        .option("driver", "org.postgresql.Driver") \
        .mode("append") \
    ...
    dim_categories_df.write \
        .format("jdbc") \
        .option("url", postgres_url) \
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.dim_categories") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
        .option("driver", "org.postgresql.Driver") \
        .mode("append") \
    ...
    dim_store_performance_df.write \
        .format("jdbc") \
        .option("url", postgres_url) \
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.dim_store_performance") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
        .option("driver", "org.postgresql.Driver") \
        .mode("append") \
    ...
    fact_products_df.write \
        .format("jdbc") \
        .option("url", postgres_url) \
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.fact_products") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
        .option("driver", "org.postgresql.Driver") \
        .mode("append") \
    ...
    fact_reviews_df.write \
        .format("jdbc") \
        .option("url", postgres_url) \
        .option("dbtable", f"{WAREHOUSE_DATABASE}.{WAREHOUSE_SCHEMA}.fact_reviews") \
        .option("user", f"{WAREHOUSE_USER}") \
        .option("password", f"{WAREHOUSE_PASSWORD}") \
        .option("driver", "org.postgresql.Driver") \
        .mode("append") \
