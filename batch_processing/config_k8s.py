...
KAFKA_BOOTSTRAP_SERVER = os.getenv("KAFKA_BOOTSTRAP_SERVER", "kafka-kafka-bootstrap.infrastructure.svc.cluster.local:9192")
...
DELTA_DATA_FOLDER = os.getenv("DELTA_DATA_FOLDER", "silver/historical-delta-format-data")
...
SCHEMA_REGISTRY_ENDPOINT = os.getenv("SCHEMA_REGISTRY_ENDPOINT", "http://schema-registry-svc.infrastructure.svc.cluster.local:8081")
...
WAREHOUSE_ENDPOINT = os.getenv("WAREHOUSE_ENDPOINT", "postgres-svc.infrastructure.svc.cluster.local")
